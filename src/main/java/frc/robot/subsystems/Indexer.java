...
indexerMotorLF = new WPI_TalonSRX(3);


        
indexerMotorLB = new WPI_TalonSRX(2);


        
indexerMotorRF = new WPI_TalonSRX(8);


        
indexerMotorRB = new WPI_TalonSRX(7);
    ...
    public void setBrakeMode(){
        ...
        indexerMotorLB.setNeutralMode(NeutralMode.Brake);
        indexerMotorRB.setNeutralMode(NeutralMode.Brake);
    }
    public void setCoastMode(){
        indexerMotorLF.setNeutralMode(NeutralMode.Coast);
        indexerMotorRF.setNeutralMode(NeutralMode.Coast);
        indexerMotorLB.setNeutralMode(NeutralMode.Coast);
        indexerMotorRB.setNeutralMode(NeutralMode.Coast);
     }
}
