...
public class PositionsControl extends CommandBase {
    ...
    public void execute() {
       // Robot.m_controlPanel.rotateColor(targetColor);
          m_controlPanel.rotateColor(targetColor);
    }

    // Make this return true when this Command no longer needs to run execute()
    @Override
    public boolean isFinished() {
        SmartDashboard.putBoolean("Is at target", targetString.equals(Robot.m_colorSensor.getColorString().substring(0, 1)));
        return targetString.equals(Robot.m_colorSensor.getColorString().substring(0, 1));
    }
