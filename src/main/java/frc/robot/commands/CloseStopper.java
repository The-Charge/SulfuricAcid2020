...
public class CloseStopper extends CommandBase {
    ...
    public CloseStopper(Shooter shooter, BallSensor ballSensor) {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
        ...
        addRequirements(m_shooter,RobotContainer.m_ballSensor);
    ...
    public boolean isFinished() {
        ...
        return RobotContainer.m_ballSensor.ballSensed();
    }
